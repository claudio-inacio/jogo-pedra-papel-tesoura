...
Ao clicar em uma opção, o computador escolhe aleatoriamente a sua jogada.

O resultado da rodada é exibido: vitória, derrota ou empate.

O placar é atualizado automaticamente a cada rodada.

O jogador pode continuar jogando quantas vezes quiser, tentando bater o computador.

✨ Objetivo: se divertir e testar sua intuição e estratégia, tentando ganhar mais rodadas que a máquina!

🧩 Conceitos e Boas Práticas Aplicadas

Manipulação de eventos (click) e DOM

Lógica condicional para decidir o vencedor

Atualização dinâmica do placar e resultados

Feedback visual e interativo para cada jogada
